...
const Banner = () => {
    return (
        <section className="text-gray-600 body-font banner-images">
  <div className="container mx-auto flex px-5 pb-12 pt-8 items-center justify-center flex-col">
    
    <div className="text-center lg:w-2/3 w-full">
      <h1 className="title-font sm:text-4xl text-6xl mb-4 font-bold text-gray-200">Good coaching is good teaching</h1>
      <p className="mb-8 px-14 py-3 text-gray-300 font-light leading-relaxed">In a coaching role, you ask the questions and rely more on your staff, who become the experts, to provide the information.</p>
